...
public class SecretaireDashboard : Form
{
    private readonly IMediator _mediator;
    private readonly ICurrentUserService _currentUserService;

    public SecretaireDashboard(IMediator mediator, ICurrentUserService currentUserService)
    {
        _mediator = mediator;
    ...
    {
        this.Text = $"GMS - Dashboard Secrétariat - {_currentUserService.NomComplet}";
        ...
        {
            Text = $"📝 Rôle: Secrétaire",
            Location = new System.Drawing.Point(30, 50),
            AutoSize = true,
            Font = new System.Drawing.Font("Segoe UI", 12),
            ForeColor = System.Drawing.Color.FromArgb(255, 245, 220)
        };
        ...
        {
            Text = "📋 Gestion des inscriptions et dossiers",
            Location = new System.Drawing.Point(30, 20),
            AutoSize = true,
            Font = new System.Drawing.Font("Segoe UI", 16, System.Drawing.FontStyle.Bold)
        };

        var cardFamilles = CreateCard("👨‍👩‍👧‍👦 Familles", "0", "Familles enregistrées", 30, 80);
        var cardEleves = CreateCard("🎓 Élèves", "0", "Élèves inscrits", 330, 80);
        var cardInscriptions = CreateCard("📝 Inscriptions", "0", "Nouvelles cette semaine", 630, 80);
        var cardDocuments = CreateCard("📄 Documents", "0", "À traiter", 930, 80);
        ...
        var btnNouvelleInscription = CreateActionButton("➕ Nouvelle Inscription", 30, 320);
        btnNouvelleInscription.Click += (s, e) => MessageBox.Show("Fonctionnalité à venir", "Information");
        ...
        var btnCertificats = CreateActionButton("📜 Certificats", 930, 320);
        btnCertificats.Click += (s, e) => MessageBox.Show("Fonctionnalité à venir", "Information");

        panelMain.Controls.AddRange(new Control[] {
            lblTitle, cardFamilles, cardEleves, cardInscriptions, cardDocuments,
            lblActions, btnNouvelleInscription, btnGestionFamilles, btnGestionEleves, btnCertificats
        });
